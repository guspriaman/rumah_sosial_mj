...
<div class="content-wrapper">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-5">
                <div class="col-sm-6">
                    <h1 class="m-0">LOKASI MINYAK JELANTAH</h1>
                </div>
                    ...
                    <?php foreach ($lokasih as $l) { ?>
                        <form action="<?= base_url('lokasih/ubahLokasih'); ?>" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-user" id="lokasih" name="lokasih" placeholder="Masukkan lokasi " value="<?= $l['lokasih']; ?>">
                            </div>
                            <div class="form-group">
