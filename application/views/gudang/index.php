                ...
                <div class="col-sm-6 mt-4">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <?php }?>
                            <?= $this->session->flashdata('pesan'); ?>
                            <a href="" class="btn btn-primary mb-3" data-toggle="modal" data-target="#gudangBaruModal"><i class="fas fa-file-alt"></i>Tambah Data MJ yg Telah Dijemput</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-12">
...
<div class="modal fade" id="gudangBaruModal" tabindex="-1" role="dialog" aria-labelledby="gudangBaruModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="gudangBaruModalLabel">Tambah Data Penjemputan</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="<?= base_url('gudang'); ?>" method="post" enctype="multipart/form-data">
